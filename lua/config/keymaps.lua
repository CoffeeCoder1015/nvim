-- [[ Keymaps ]]
-- Merged: user custom keymaps + LazyVim default keymaps
...
require("config.format").snacks_toggle():map("<leader>uf")
require("config.format").snacks_toggle(true):map("<leader>uF")
...
-- =============================================
-- User custom keymaps (preserved from original)
-- =============================================

-- map for going into netrw
map("n", "<leader>nrw", vim.cmd.Ex, { desc = "open up netrw" })
